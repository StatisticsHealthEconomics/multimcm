...
#include "stanExports_lognormal_relative_mix.h"

RCPP_MODULE(stan_fit4lognormal_relative_mix_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lognormal_relative_mix")
