...
namespace model_loglogistic_loglogistic_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_loglogistic_loglogistic");
    ...
    reader.add_event(465, 6, "restart", "model_loglogistic_loglogistic");
    reader.add_event(749, 288, "end", "model_loglogistic_loglogistic");
    return reader;
}
...
class model_loglogistic_loglogistic
  : public stan::model::model_base_crtp<model_loglogistic_loglogistic> {
private:
        int n_os;
        int n_pfs;
        int H_os;
        ...
        int t_max;
public:
    model_loglogistic_loglogistic(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_loglogistic_loglogistic_namespace::model_loglogistic_loglogistic";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n_os; ++i) {
                ...
                lp_accum__.add((log_sum_exp((stan::math::log(cf_os) + surv_exp_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__)), (log1m(cf_os) + joint_exp_loglogistic_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), shape_os, get_base1(lambda_os, i, "lambda_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__))) + log_sum_exp((stan::math::log(cf_pfs) + surv_exp_lpdf(get_base1(t_pfs, i, "t_pfs", 1), get_base1(d_pfs, i, "d_pfs", 1), get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), pstream__)), (log1m(cf_pfs) + joint_exp_loglogistic_lpdf(get_base1(t_pfs, i, "t_pfs", 1), get_base1(d_pfs, i, "d_pfs", 1), shape_pfs, get_base1(lambda_pfs, i, "lambda_pfs", 1), get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), pstream__)))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("pshape_pfs");
        names__.push_back("pshape_os");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_loglogistic_loglogistic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            double pshape_pfs;
            (void) pshape_pfs;  // dummy to suppress unused var warning
            stan::math::initialize(pshape_pfs, DUMMY_VAR__);
            stan::math::fill(pshape_pfs, DUMMY_VAR__);
            stan::math::assign(pshape_pfs,gamma_rng(a_shape_pfs, b_shape_pfs, base_rng__));
            current_statement_begin__ = 660;
            double pshape_os;
            (void) pshape_os;  // dummy to suppress unused var warning
            stan::math::initialize(pshape_os, DUMMY_VAR__);
            stan::math::fill(pshape_os, DUMMY_VAR__);
            stan::math::assign(pshape_os,gamma_rng(a_shape_os, b_shape_os, base_rng__));
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(S_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_loglogistic_Surv(i, shape_os, mean_os, mean_bg, pstream__), 
                            "assigning variable S_os");
                current_statement_begin__ = 711;
                stan::model::assign(S_pfs, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_loglogistic_Surv(i, shape_pfs, mean_pfs, mean_bg, pstream__), 
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(pS_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_loglogistic_Surv(i, pshape_os, pmean_os, pmean_bg, pstream__), 
                            "assigning variable pS_os");
                current_statement_begin__ = 725;
                stan::model::assign(pS_pfs, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_loglogistic_Surv(i, pshape_pfs, pmean_pfs, pmean_bg, pstream__), 
            ...
            for (int n = 1; n <= n_os; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            (log_sum_exp((stan::math::log(cf_os) + surv_exp_lpdf(get_base1(t_os, n, "t_os", 1), get_base1(d_os, n, "d_os", 1), get_base1(lambda_os_bg, n, "lambda_os_bg", 1), pstream__)), (log1m(cf_os) + joint_exp_loglogistic_lpdf(get_base1(t_os, n, "t_os", 1), get_base1(d_os, n, "d_os", 1), shape_os, get_base1(lambda_os, n, "lambda_os", 1), get_base1(lambda_os_bg, n, "lambda_os_bg", 1), pstream__))) + log_sum_exp((stan::math::log(cf_pfs) + surv_exp_lpdf(get_base1(t_pfs, n, "t_pfs", 1), get_base1(d_pfs, n, "d_pfs", 1), get_base1(lambda_pfs_bg, n, "lambda_pfs_bg", 1), pstream__)), (log1m(cf_pfs) + joint_exp_loglogistic_lpdf(get_base1(t_pfs, n, "t_pfs", 1), get_base1(d_pfs, n, "d_pfs", 1), shape_pfs, get_base1(lambda_pfs, n, "lambda_pfs", 1), get_base1(lambda_pfs_bg, n, "lambda_pfs_bg", 1), pstream__)))), 
            ...
            current_statement_begin__ = 659;
            vars__.push_back(pshape_pfs);
            current_statement_begin__ = 660;
            vars__.push_back(pshape_os);
            current_statement_begin__ = 662;
    ...
    std::string model_name() const {
        return "model_loglogistic_loglogistic";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "pshape_pfs";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "pshape_os";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
...
typedef model_loglogistic_loglogistic_namespace::model_loglogistic_loglogistic stan_model;
#ifndef USING_R
