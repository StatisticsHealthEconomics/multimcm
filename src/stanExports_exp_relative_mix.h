...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(454, 446, "end", "/include/distributions.stan");
    reader.add_event(454, 9, "restart", "model_exp_relative_mix");
    reader.add_event(573, 126, "end", "model_exp_relative_mix");
    return reader;
}
