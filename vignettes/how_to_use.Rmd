...
The function `plot_S_joint()` takes a list of multiple Stan runs and creates `ggplot2` grid object of survival curves.
...
In addition, we overlay the Kaplan-Meier curve for the original data.
