...
Alternatively, we can pass in a precompiled model.

```{r}
model_nm <- "precompiled_stan_model"

precompile_bmcm_model(input_data = input_data, cureformula =  "~ treat + (1 | center_id)", family_latent = "exponential", model_name = model_nm)
