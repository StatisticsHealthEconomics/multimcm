...
namespace model_exp_gompertz_joint_mix_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_exp_gompertz_joint_mix");
    ...
    reader.add_event(418, 5, "restart", "model_exp_gompertz_joint_mix");
    reader.add_event(610, 195, "end", "model_exp_gompertz_joint_mix");
    return reader;
}
...
class model_exp_gompertz_joint_mix
  : public stan::model::model_base_crtp<model_exp_gompertz_joint_mix> {
private:
        int n_os;
        int n_pfs;
        int H_os;
        ...
        std::vector<int> x_i;
public:
    model_exp_gompertz_joint_mix(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exp_gompertz_joint_mix_namespace::model_exp_gompertz_joint_mix";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exp_gompertz_joint_mix_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_exp_gompertz_joint_mix";
    }
...
typedef model_exp_gompertz_joint_mix_namespace::model_exp_gompertz_joint_mix stan_model;
#ifndef USING_R
