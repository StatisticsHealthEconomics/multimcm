...
#include "stanExports_exp_lognormalTx.h"

RCPP_MODULE(stan_fit4exp_lognormalTx_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_exp_lognormalTx")
