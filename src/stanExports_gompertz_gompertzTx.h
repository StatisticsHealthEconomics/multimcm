...
namespace model_gompertz_gompertzTx_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gompertz_gompertzTx");
    ...
    reader.add_event(451, 6, "restart", "model_gompertz_gompertzTx");
    reader.add_event(790, 343, "end", "model_gompertz_gompertzTx");
    return reader;
}
...
class model_gompertz_gompertzTx
  : public stan::model::model_base_crtp<model_gompertz_gompertzTx> {
private:
        int nTx;
        int N_os;
        int N_pfs;
...
public:
    model_gompertz_gompertzTx(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gompertz_gompertzTx_namespace::model_gompertz_gompertzTx";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "a_shape_pfs", "double", context__.to_vec());
            a_shape_pfs = double(0);
            vals_r__ = context__.vals_r("a_shape_pfs");
            pos__ = 0;
            a_shape_pfs = vals_r__[pos__++];
            check_greater_or_equal(function__, "a_shape_pfs", a_shape_pfs, 0);
            current_statement_begin__ = 474;
            context__.validate_dims("data initialization", "b_shape_pfs", "double", context__.to_vec());
            b_shape_pfs = double(0);
            vals_r__ = context__.vals_r("b_shape_pfs");
            pos__ = 0;
            b_shape_pfs = vals_r__[pos__++];
            check_greater_or_equal(function__, "b_shape_pfs", b_shape_pfs, 0);
            current_statement_begin__ = 475;
            context__.validate_dims("data initialization", "a_shape_os", "double", context__.to_vec());
            a_shape_os = double(0);
            vals_r__ = context__.vals_r("a_shape_os");
            pos__ = 0;
            a_shape_os = vals_r__[pos__++];
            check_greater_or_equal(function__, "a_shape_os", a_shape_os, 0);
            current_statement_begin__ = 476;
            context__.validate_dims("data initialization", "b_shape_os", "double", context__.to_vec());
            b_shape_os = double(0);
            vals_r__ = context__.vals_r("b_shape_os");
            pos__ = 0;
            b_shape_os = vals_r__[pos__++];
            check_greater_or_equal(function__, "b_shape_os", b_shape_os, 0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 521;
        if (!(context__.contains_r("shape_pfs")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable shape_pfs missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("shape_pfs");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "shape_pfs", "double", context__.to_vec());
        double shape_pfs(0);
        shape_pfs = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, shape_pfs);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable shape_pfs: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 522;
        if (!(context__.contains_r("shape_os")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable shape_os missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("shape_os");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "shape_os", "double", context__.to_vec());
        double shape_os(0);
        shape_os = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, shape_os);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable shape_os: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 524;
        ...
        try {
            writer__.vector_unconstrain(lp_cf_os);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 521;
            local_scalar_t__ shape_pfs;
            (void) shape_pfs;  // dummy to suppress unused var warning
            if (jacobian__)
                shape_pfs = in__.scalar_lb_constrain(0, lp__);
            else
                shape_pfs = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 522;
            local_scalar_t__ shape_os;
            (void) shape_os;  // dummy to suppress unused var warning
            if (jacobian__)
                shape_os = in__.scalar_lb_constrain(0, lp__);
            else
                shape_os = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 524;
            ...
            lp_accum__.add(gamma_log<propto__>(shape_pfs, a_shape_pfs, b_shape_pfs));
            current_statement_begin__ = 594;
            lp_accum__.add(gamma_log<propto__>(shape_os, a_shape_os, b_shape_os));
            ...
            for (int Tx = 1; Tx <= nTx; ++Tx) {
                ...
                for (int i = idx_os; i <= ((idx_os + get_base1(n_os, Tx, "n_os", 1)) - 1); ++i) {
                    ...
                    lp_accum__.add(log_sum_exp((stan::math::log(get_base1(cf_os, Tx, "cf_os", 1)) + surv_exp_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__)), (log1m(get_base1(cf_os, Tx, "cf_os", 1)) + joint_exp_gompertz_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), shape_os, get_base1(lambda_os, i, "lambda_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__))));
                }
                current_statement_begin__ = 634;
                for (int j = idx_pfs; j <= ((idx_pfs + get_base1(n_pfs, Tx, "n_pfs", 1)) - 1); ++j) {
                    current_statement_begin__ = 636;
                    lp_accum__.add(log_sum_exp((stan::math::log(get_base1(cf_pfs, Tx, "cf_pfs", 1)) + surv_exp_lpdf(get_base1(t_pfs, j, "t_pfs", 1), get_base1(d_pfs, j, "d_pfs", 1), get_base1(lambda_pfs_bg, j, "lambda_pfs_bg", 1), pstream__)), (log1m(get_base1(cf_pfs, Tx, "cf_pfs", 1)) + joint_exp_gompertz_lpdf(get_base1(t_pfs, j, "t_pfs", 1), get_base1(d_pfs, j, "d_pfs", 1), shape_pfs, get_base1(lambda_pfs, j, "lambda_pfs", 1), get_base1(lambda_pfs_bg, j, "lambda_pfs_bg", 1), pstream__))));
                }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("shape_pfs");
        names__.push_back("shape_os");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gompertz_gompertzTx_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double shape_pfs = in__.scalar_lb_constrain(0);
        vars__.push_back(shape_pfs);
        double shape_os = in__.scalar_lb_constrain(0);
        vars__.push_back(shape_os);
            ...
            for (int j = 1; j <= nTx; ++j) {
                ...
                for (int i = 1; i <= t_max; ++i) {
                    ...
                    stan::model::assign(S_os, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                exp_gompertz_Surv(i, shape_os, mean_os, mean_bg, pstream__), 
                                "assigning variable S_os");
                    current_statement_begin__ = 735;
                    stan::model::assign(S_pfs, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                exp_gompertz_Surv(i, shape_pfs, mean_pfs, mean_bg, pstream__), 
    ...
    std::string model_name() const {
        return "model_gompertz_gompertzTx";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "shape_pfs";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "shape_os";
        param_names__.push_back(param_name_stream__.str());
        size_t alpha_j_1_max__ = nTx;
        for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef model_gompertz_gompertzTx_namespace::model_gompertz_gompertzTx stan_model;
#ifndef USING_R
