...
namespace model_weibull_relative_mix_full_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_weibull_relative_mix_full");
    ...
    reader.add_event(148, 5, "restart", "model_weibull_relative_mix_full");
    reader.add_event(233, 88, "end", "model_weibull_relative_mix_full");
    return reader;
}
...
class model_weibull_relative_mix_full
  : public stan::model::model_base_crtp<model_weibull_relative_mix_full> {
private:
        int n;
        vector_d t;
        vector_d d;
        ...
        int t_max;
public:
    model_weibull_relative_mix_full(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_weibull_relative_mix_full_namespace::model_weibull_relative_mix_full";
    ...
    ~model_weibull_relative_mix_full() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                lp_accum__.add(log_sum_exp((stan::math::log(get_base1(curefrac, i, "curefrac", 1)) + surv_exp_lpdf(get_base1(t, i, "t", 1), get_base1(d, i, "d", 1), get_base1(lambda_bg, i, "lambda_bg", 1), pstream__)), (log1m(get_base1(curefrac, i, "curefrac", 1)) + joint_exp_weibull_lpdf(get_base1(t, i, "t", 1), get_base1(d, i, "d", 1), alpha0, get_base1(lambda0, i, "lambda0", 1), get_base1(lambda_bg, i, "lambda_bg", 1), pstream__))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_weibull_relative_mix_full_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(S_pred, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((gen_cf * get_base1(S_bg, i, "S_bg", 1)) + (((1 - gen_cf) * get_base1(S0, i, "S0", 1)) * get_base1(S_bg, i, "S_bg", 1))), 
    ...
    std::string model_name() const {
        return "model_weibull_relative_mix_full";
    }
...
typedef model_weibull_relative_mix_full_namespace::model_weibull_relative_mix_full stan_model;
#ifndef USING_R
