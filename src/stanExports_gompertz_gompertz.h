...
namespace model_gompertz_gompertz_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gompertz_gompertz");
    ...
    reader.add_event(465, 6, "restart", "model_gompertz_gompertz");
    reader.add_event(748, 287, "end", "model_gompertz_gompertz");
    return reader;
}
...
class model_gompertz_gompertz
  : public stan::model::model_base_crtp<model_gompertz_gompertz> {
private:
        int n_os;
        int n_pfs;
        int H_os;
        ...
        int t_max;
public:
    model_gompertz_gompertz(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gompertz_gompertz_namespace::model_gompertz_gompertz";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n_os; ++i) {
                ...
                lp_accum__.add((log_sum_exp((stan::math::log(cf_os) + surv_exp_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__)), (log1m(cf_os) + joint_exp_gompertz_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), shape_os, get_base1(lambda_os, i, "lambda_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__))) + log_sum_exp((stan::math::log(cf_pfs) + surv_exp_lpdf(get_base1(t_pfs, i, "t_pfs", 1), get_base1(d_pfs, i, "d_pfs", 1), get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), pstream__)), (log1m(cf_pfs) + joint_exp_gompertz_lpdf(get_base1(t_pfs, i, "t_pfs", 1), get_base1(d_pfs, i, "d_pfs", 1), shape_pfs, get_base1(lambda_pfs, i, "lambda_pfs", 1), get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), pstream__)))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gompertz_gompertz_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(pS_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_gompertz_Surv(i, pshape_os, pmean_os, pmean_bg, pstream__), 
                            "assigning variable pS_os");
                current_statement_begin__ = 724;
                stan::model::assign(pS_pfs, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_gompertz_Surv(i, pshape_pfs, pmean_pfs, pmean_bg, pstream__), 
            ...
            for (int n = 1; n <= n_os; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            (log_sum_exp((stan::math::log(cf_os) + surv_exp_lpdf(get_base1(t_os, n, "t_os", 1), get_base1(d_os, n, "d_os", 1), get_base1(lambda_os_bg, n, "lambda_os_bg", 1), pstream__)), (log1m(cf_os) + joint_exp_gompertz_lpdf(get_base1(t_os, n, "t_os", 1), get_base1(d_os, n, "d_os", 1), shape_os, get_base1(lambda_os, n, "lambda_os", 1), get_base1(lambda_os_bg, n, "lambda_os_bg", 1), pstream__))) + log_sum_exp((stan::math::log(cf_pfs) + surv_exp_lpdf(get_base1(t_pfs, n, "t_pfs", 1), get_base1(d_pfs, n, "d_pfs", 1), get_base1(lambda_pfs_bg, n, "lambda_pfs_bg", 1), pstream__)), (log1m(cf_pfs) + joint_exp_gompertz_lpdf(get_base1(t_pfs, n, "t_pfs", 1), get_base1(d_pfs, n, "d_pfs", 1), shape_pfs, get_base1(lambda_pfs, n, "lambda_pfs", 1), get_base1(lambda_pfs_bg, n, "lambda_pfs_bg", 1), pstream__)))), 
    ...
    std::string model_name() const {
        return "model_gompertz_gompertz";
    }
...
typedef model_gompertz_gompertz_namespace::model_gompertz_gompertz stan_model;
#ifndef USING_R
