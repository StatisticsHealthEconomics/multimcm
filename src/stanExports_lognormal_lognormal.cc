...
#include "stanExports_lognormal_lognormal.h"

RCPP_MODULE(stan_fit4lognormal_lognormal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lognormal_lognormal")
