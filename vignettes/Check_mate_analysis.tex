...
Figures \ref{fig:forest_separate} shows the forest plots of cure
...
\caption{\label{fig:forest_separate}Forest plot of cure fraction posterior distributions for separate OS and PFS models .}\label{fig:unnamed-chunk-6}
\end{figure}
