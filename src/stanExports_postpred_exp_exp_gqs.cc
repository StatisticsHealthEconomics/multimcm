...
#include "stanExports_postpred_exp_exp_gqs.h"

RCPP_MODULE(stan_fit4postpred_exp_exp_gqs_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_postpred_exp_exp_gqs")
