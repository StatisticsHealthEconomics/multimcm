...
#include "stanExports_exp_exp_joint_hiercfTx.h"

RCPP_MODULE(stan_fit4exp_exp_joint_hiercfTx_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_exp_exp_joint_hiercfTx")
