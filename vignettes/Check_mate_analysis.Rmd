...
Figure \ref{fig:forest_separate} shows the forest plots of cure
fraction posterior distributions.
...
+----------+----------+----------+----------+----------+----------+
|          | OS Distn | PFS      | T        | $        | $c       |
|          |          | Distn    | reatment | cf_{OS}$ | f_{PFS}$ |
|          |          |          |          | (CrI)    | (CrI)    |
+:=========+:=========+:=========+:=========+:=========+:=========+
| 1        | exp      | exp      | IP       | 0.216    | 0.128    |
|          |          |          | ILIMUMAB | (0.16,   | (0.089,  |
|          |          |          |          | 0.271)   | 0.173)   |
+----------+----------+----------+----------+----------+----------+
| 2        | exp      | exp      | N        | 0.417    | 0.32     |
|          |          |          | IVOLUMAB | (0.335,  | (0.268,  |
|          |          |          |          | 0.482)   | 0.37)    |
+----------+----------+----------+----------+----------+----------+
| 3        | exp      | exp      | NIVO     | 0.509    | 0.387    |
|          |          |          | LUMAB+IP | (0.43,   | (0.332,  |
|          |          |          | ILIMUMAB | 0.573)   | 0.441)   |
+----------+----------+----------+----------+----------+----------+
| 4        | gompertz | gompertz | IP       | 0.221    | 0.126    |
|          |          |          | ILIMUMAB | (0.176,  | (0.092,  |
|          |          |          |          | 0.282)   | 0.156)   |
+----------+----------+----------+----------+----------+----------+
| 5        | gompertz | gompertz | N        | 0.414    | 0.321    |
|          |          |          | IVOLUMAB | (0.352,  | (0.274,  |
|          |          |          |          | 0.477)   | 0.383)   |
+----------+----------+----------+----------+----------+----------+
| 6        | gompertz | gompertz | NIVO     | 0.51     | 0.39     |
|          |          |          | LUMAB+IP | (0.447,  | (0.323,  |
|          |          |          | ILIMUMAB | 0.575)   | 0.457)   |
+----------+----------+----------+----------+----------+----------+
| 7        | log      | log      | IP       | 0.183    | 0.13     |
|          | logistic | logistic | ILIMUMAB | (0.11,   | (0.091,  |
|          |          |          |          | 0.265)   | 0.168)   |
+----------+----------+----------+----------+----------+----------+
| 8        | log      | log      | N        | 0.329    | 0.321    |
|          | logistic | logistic | IVOLUMAB | (0.217,  | (0.267,  |
|          |          |          |          | 0.423)   | 0.381)   |
+----------+----------+----------+----------+----------+----------+
| 9        | log      | log      | NIVO     | 0.449    | 0.359    |
|          | logistic | logistic | LUMAB+IP | (0.349,  | (0.308,  |
|          |          |          | ILIMUMAB | 0.524)   | 0.427)   |
+----------+----------+----------+----------+----------+----------+
| 10       | l        | l        | IP       | 0.304    | 0.175    |
|          | ognormal | ognormal | ILIMUMAB | (0.241,  | (0.13,   |
|          |          |          |          | 0.378)   | 0.207)   |
+----------+----------+----------+----------+----------+----------+
| 11       | l        | l        | N        | 0.477    | 0.424    |
|          | ognormal | ognormal | IVOLUMAB | (0.432,  | (0.375,  |
|          |          |          |          | 0.531)   | 0.467)   |
+----------+----------+----------+----------+----------+----------+
| 12       | l        | l        | NIVO     | 0.55     | 0.411    |
|          | ognormal | ognormal | LUMAB+IP | (0.487,  | (0.365,  |
|          |          |          | ILIMUMAB | 0.611)   | 0.459)   |
+----------+----------+----------+----------+----------+----------+
| 13       | weibull  | weibull  | IP       | 0.238    | 0.146    |
|          |          |          | ILIMUMAB | (0.177,  | (0.105,  |
|          |          |          |          | 0.285)   | 0.186)   |
+----------+----------+----------+----------+----------+----------+
| 14       | weibull  | weibull  | N        | 0.425    | 0.317    |
|          |          |          | IVOLUMAB | (0.348,  | (0.261,  |
|          |          |          |          | 0.51)    | 0.378)   |
+----------+----------+----------+----------+----------+----------+
| 15       | weibull  | weibull  | NIVO     | 0.504    | 0.392    |
|          |          |          | LUMAB+IP | (0.423,  | (0.339,  |
|          |          |          | ILIMUMAB | 0.566)   | 0.45)    |
+----------+----------+----------+----------+----------+----------+
Table: Posterior cure fractions.

The table below gives the leave-one-out cross validation statistics for
each model fit using WAIC (@Vehtari2017).
...
Table: leave-one-out cross validation statistics for each model fit using WAIC.
...
+---------+---------+---------+---------+---------+---------+---------+
|         | OS      | PFS     | Tr      | $cf$    | $c      | $cf     |
|         | Distn   | Distn   | eatment | (CrI)   | f_{OS}$ | _{PFS}$ |
|         |         |         |         |         | (CrI)   | (CrI)   |
+:========+:========+:========+:========+:========+:========+:========+
| 1       | exp     | exp     | IPI     | 0.151   | 0.196   | 0.112   |
|         |         |         | LIMUMAB | (0.068, | (0.136, | (0.079, |
|         |         |         |         | 0.26)   | 0.255)  | 0.155)  |
+---------+---------+---------+---------+---------+---------+---------+
| 2       | exp     | exp     | NI      | 0.378   | 0.412   | 0.321   |
|         |         |         | VOLUMAB | (0.216, | (0.35,  | (0.262, |
|         |         |         |         | 0.557)  | 0.479)  | 0.379)  |
+---------+---------+---------+---------+---------+---------+---------+
| 3       | exp     | exp     | NIVOLU  | 0.463   | 0.526   | 0.392   |
|         |         |         | MAB+IPI | (0.328, | (0.452, | (0.334, |
|         |         |         | LIMUMAB | 0.626)  | 0.597)  | 0.448)  |
+---------+---------+---------+---------+---------+---------+---------+
| 4       | g       | g       | IPI     | 0.164   | 0.207   | 0.114   |
|         | ompertz | ompertz | LIMUMAB | (0.088, | (0.13,  | (0.079, |
|         |         |         |         | 0.275)  | 0.266)  | 0.148)  |
+---------+---------+---------+---------+---------+---------+---------+
| 5       | g       | g       | NI      | 0.368   | 0.423   | 0.321   |
|         | ompertz | ompertz | VOLUMAB | (0.247, | (0.358, | (0.261, |
|         |         |         |         | 0.517)  | 0.494)  | 0.369)  |
+---------+---------+---------+---------+---------+---------+---------+
| 6       | g       | g       | NIVOLU  | 0.458   | 0.529   | 0.395   |
|         | ompertz | ompertz | MAB+IPI | (0.318, | (0.477, | (0.346, |
|         |         |         | LIMUMAB | 0.612)  | 0.594)  | 0.446)  |
+---------+---------+---------+---------+---------+---------+---------+
| 7       | logl    | logl    | IPI     | 0.133   | 0.133   | 0.113   |
|         | ogistic | ogistic | LIMUMAB | (0.061, | (0.054, | (0.075, |
|         |         |         |         | 0.278)  | 0.206)  | 0.152)  |
+---------+---------+---------+---------+---------+---------+---------+
| 8       | logl    | logl    | NI      | 0.348   | 0.345   | 0.325   |
|         | ogistic | ogistic | VOLUMAB | (0.191, | (0.231, | (0.264, |
|         |         |         |         | 0.526)  | 0.456)  | 0.382)  |
+---------+---------+---------+---------+---------+---------+---------+
| 9       | logl    | logl    | NIVOLU  | 0.421   | 0.459   | 0.375   |
|         | ogistic | ogistic | MAB+IPI | (0.266, | (0.37,  | (0.327, |
|         |         |         | LIMUMAB | 0.599)  | 0.535)  | 0.421)  |
+---------+---------+---------+---------+---------+---------+---------+
| 10      | lo      | lo      | IPI     | 0.236   | 0.285   | 0.177   |
|         | gnormal | gnormal | LIMUMAB | (0.127, | (0.198, | (0.136, |
|         |         |         |         | 0.303)  | 0.468)  | 0.293)  |
+---------+---------+---------+---------+---------+---------+---------+
| 11      | lo      | lo      | NI      | 0.425   | 0.486   | 0.437   |
|         | gnormal | gnormal | VOLUMAB | (0.286, | (0.431, | (0.39,  |
|         |         |         |         | 0.588)  | 0.546)  | 0.48)   |
+---------+---------+---------+---------+---------+---------+---------+
| 12      | lo      | lo      | NIVOLU  | 0.431   | 0.556   | 0.42    |
|         | gnormal | gnormal | MAB+IPI | (0.301, | (0.494, | (0.37,  |
|         |         |         | LIMUMAB | 0.581)  | 0.619)  | 0.481)  |
+---------+---------+---------+---------+---------+---------+---------+
| 13      | weibull | weibull | IPI     | 0.184   | 0.229   | 0.141   |
|         |         |         | LIMUMAB | (0.095, | (0.157, | (0.107, |
|         |         |         |         | 0.29)   | 0.295)  | 0.177)  |
+---------+---------+---------+---------+---------+---------+---------+
| 14      | weibull | weibull | NI      | 0.375   | 0.427   | 0.326   |
|         |         |         | VOLUMAB | (0.242, | (0.346, | (0.27,  |
|         |         |         |         | 0.541)  | 0.494)  | 0.394)  |
+---------+---------+---------+---------+---------+---------+---------+
| 15      | weibull | weibull | NIVOLU  | 0.471   | 0.523   | 0.399   |
|         |         |         | MAB+IPI | (0.328, | (0.461, | (0.35,  |
|         |         |         | LIMUMAB | 0.647)  | 0.58)   | 0.462)  |
+---------+---------+---------+---------+---------+---------+---------+
Table: cure fraction posterior distribution for each scenario.
...
Table: leave-one-out cross validation statistics for each model fit.
...
Table: variance partition coefficient (VPC).
...
$nivolumab$ treatment and background hazard ratio adjustment 1.63. There
is a small increase of approximately 1-2% in the cure fraction
estimates.
...
|         |         |         |         |         | (CrI)   | (CrI)   |
+:========+:========+:========+:========+:========+:========+:========+
| 1       | exp     | exp     | NIVOLU  | 0.45    | 0.538   | 0.402   |
|         |         |         | MAB+IPI | (0.291, | (0.473, | (0.351, |
|         |         |         | LIMUMAB | 0.646)  | 0.588)  | 0.457)  |
+---------+---------+---------+---------+---------+---------+---------+
| 2       | g       | g       | NIVOLU  | 0.459   | 0.541   | 0.409   |
|         | ompertz | ompertz | MAB+IPI | (0.287, | (0.448, | (0.349, |
|         |         |         | LIMUMAB | 0.616)  | 0.6)    | 0.474)  |
+---------+---------+---------+---------+---------+---------+---------+
| 3       | logl    | logl    | NIVOLU  | 0.433   | 0.482   | 0.39    |
|         | ogistic | ogistic | MAB+IPI | (0.287, | (0.374, | (0.324, |
|         |         |         | LIMUMAB | 0.601)  | 0.567)  | 0.444)  |
+---------+---------+---------+---------+---------+---------+---------+
| 4       | lo      | lo      | NIVOLU  | 0.46    | 0.583   | 0.434   |
|         | gnormal | gnormal | MAB+IPI | (0.289, | (0.531, | (0.381, |
|         |         |         | LIMUMAB | 0.648)  | 0.643)  | 0.491)  |
+---------+---------+---------+---------+---------+---------+---------+
| 5       | weibull | weibull | NIVOLU  | 0.469   | 0.546   | 0.409   |
|         |         |         | MAB+IPI | (0.297, | (0.496, | (0.354, |
|         |         |         | LIMUMAB | 0.62)   | 0.592)  | 0.459)  |
+---------+---------+---------+---------+---------+---------+---------+
Table: cure fraction posterior distribution for each scenario.
