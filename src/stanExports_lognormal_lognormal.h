...
namespace model_lognormal_lognormal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lognormal_lognormal");
    ...
    reader.add_event(465, 6, "restart", "model_lognormal_lognormal");
    reader.add_event(772, 311, "end", "model_lognormal_lognormal");
    return reader;
}
...
class model_lognormal_lognormal
  : public stan::model::model_base_crtp<model_lognormal_lognormal> {
private:
        int n_os;
        int n_pfs;
        int H_os;
        ...
        int t_max;
public:
    model_lognormal_lognormal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lognormal_lognormal_namespace::model_lognormal_lognormal";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "a_sd_os", "double", context__.to_vec());
            a_sd_os = double(0);
            vals_r__ = context__.vals_r("a_sd_os");
            pos__ = 0;
            a_sd_os = vals_r__[pos__++];
            check_greater_or_equal(function__, "a_sd_os", a_sd_os, 0);
            current_statement_begin__ = 488;
            context__.validate_dims("data initialization", "b_sd_os", "double", context__.to_vec());
            b_sd_os = double(0);
            vals_r__ = context__.vals_r("b_sd_os");
            pos__ = 0;
            b_sd_os = vals_r__[pos__++];
            check_greater_or_equal(function__, "b_sd_os", b_sd_os, 0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 526;
        if (!(context__.contains_r("sd_os")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sd_os missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sd_os");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sd_os", "double", context__.to_vec());
        double sd_os(0);
        sd_os = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sd_os);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sd_os: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 528;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 526;
            local_scalar_t__ sd_os;
            (void) sd_os;  // dummy to suppress unused var warning
            if (jacobian__)
                sd_os = in__.scalar_lb_constrain(0, lp__);
            else
                sd_os = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 528;
            ...
            validate_non_negative_index("mean_os", "n_os", n_os);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mean_os(n_os);
            stan::math::initialize(mean_os, DUMMY_VAR__);
            stan::math::fill(mean_os, DUMMY_VAR__);
            current_statement_begin__ = 541;
            validate_non_negative_index("mean_pfs", "n_pfs", n_pfs);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mean_pfs(n_pfs);
            ...
            stan::math::assign(mean_os, lp_os);
            current_statement_begin__ = 570;
            stan::math::assign(mean_pfs, lp_pfs);
            ...
            current_statement_begin__ = 540;
            size_t mean_os_j_1_max__ = n_os;
            for (size_t j_1__ = 0; j_1__ < mean_os_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(mean_os(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: mean_os" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mean_os: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 541;
            size_t mean_pfs_j_1_max__ = n_pfs;
            for (size_t j_1__ = 0; j_1__ < mean_pfs_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(mean_pfs(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: mean_pfs" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mean_pfs: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 542;
            ...
            lp_accum__.add(gamma_log<propto__>(sd_os, a_sd_os, b_sd_os));
            ...
            for (int i = 1; i <= n_os; ++i) {
                ...
                lp_accum__.add((log_sum_exp((stan::math::log(cf_os) + surv_exp_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__)), (log1m(cf_os) + joint_exp_lognormal_lpdf(get_base1(t_os, i, "t_os", 1), get_base1(d_os, i, "d_os", 1), get_base1(mean_os, i, "mean_os", 1), sd_os, get_base1(lambda_os_bg, i, "lambda_os_bg", 1), pstream__))) + log_sum_exp((stan::math::log(cf_pfs) + surv_exp_lpdf(get_base1(t_pfs, i, "t_pfs", 1), get_base1(d_pfs, i, "d_pfs", 1), get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), pstream__)), (log1m(cf_pfs) + joint_exp_lognormal_lpdf(get_base1(t_pfs, i, "t_pfs", 1), get_base1(d_pfs, i, "d_pfs", 1), get_base1(mean_pfs, i, "mean_pfs", 1), sd_pfs, get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), pstream__)))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("mean_lp_os");
        names__.push_back("mean_lp_pfs");
        names__.push_back("mean_lp_bg");
        ...
        names__.push_back("psd_os");
        names__.push_back("pbeta_bg");
        names__.push_back("cf_tilde");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lognormal_lognormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double sd_os = in__.scalar_lb_constrain(0);
        vars__.push_back(sd_os);
        ...
        try {
            ...
            current_statement_begin__ = 540;
            validate_non_negative_index("mean_os", "n_os", n_os);
            Eigen::Matrix<double, Eigen::Dynamic, 1> mean_os(n_os);
            stan::math::initialize(mean_os, DUMMY_VAR__);
            stan::math::fill(mean_os, DUMMY_VAR__);
            current_statement_begin__ = 541;
            validate_non_negative_index("mean_pfs", "n_pfs", n_pfs);
            Eigen::Matrix<double, Eigen::Dynamic, 1> mean_pfs(n_pfs);
            stan::math::initialize(mean_pfs, DUMMY_VAR__);
            stan::math::fill(mean_pfs, DUMMY_VAR__);
            current_statement_begin__ = 542;
            validate_non_negative_index("lambda_os_bg", "n_os", n_os);
            ...
            if (include_tparams__) {
                ...
                size_t mean_os_j_1_max__ = n_os;
                for (size_t j_1__ = 0; j_1__ < mean_os_j_1_max__; ++j_1__) {
                    vars__.push_back(mean_os(j_1__));
                }
                size_t mean_pfs_j_1_max__ = n_pfs;
                for (size_t j_1__ = 0; j_1__ < mean_pfs_j_1_max__; ++j_1__) {
                    vars__.push_back(mean_pfs(j_1__));
                }
                size_t lambda_os_bg_j_1_max__ = n_os;
                for (size_t j_1__ = 0; j_1__ < lambda_os_bg_j_1_max__; ++j_1__) {
            ...
            double mean_lp_os;
            (void) mean_lp_os;  // dummy to suppress unused var warning
            stan::math::initialize(mean_lp_os, DUMMY_VAR__);
            stan::math::fill(mean_lp_os, DUMMY_VAR__);
            current_statement_begin__ = 632;
            double mean_lp_pfs;
            (void) mean_lp_pfs;  // dummy to suppress unused var warning
            stan::math::initialize(mean_lp_pfs, DUMMY_VAR__);
            stan::math::fill(mean_lp_pfs, DUMMY_VAR__);
            current_statement_begin__ = 633;
            double mean_lp_bg;
            (void) mean_lp_bg;  // dummy to suppress unused var warning
            stan::math::initialize(mean_lp_bg, DUMMY_VAR__);
            stan::math::fill(mean_lp_bg, DUMMY_VAR__);
            ...
            double psd_os;
            (void) psd_os;  // dummy to suppress unused var warning
            stan::math::initialize(psd_os, DUMMY_VAR__);
            stan::math::fill(psd_os, DUMMY_VAR__);
            stan::math::assign(psd_os,gamma_rng(a_sd_os, b_sd_os, base_rng__));
            ...
            validate_non_negative_index("cf_tilde", "n_os", n_os);
            std::vector<double> cf_tilde(n_os, double(0));
            stan::math::initialize(cf_tilde, DUMMY_VAR__);
            stan::math::fill(cf_tilde, DUMMY_VAR__);
            current_statement_begin__ = 665;
            validate_non_negative_index("t_os_tilde", "n_os", n_os);
            std::vector<double> t_os_tilde(n_os, double(0));
            stan::math::initialize(t_os_tilde, DUMMY_VAR__);
            stan::math::fill(t_os_tilde, DUMMY_VAR__);
            current_statement_begin__ = 666;
            validate_non_negative_index("t_pfs_tilde", "n_os", n_os);
            std::vector<double> t_pfs_tilde(n_os, double(0));
            ...
            stan::math::assign(mean_lp_os, get_base1(beta_os, 1, "beta_os", 1));
            current_statement_begin__ = 702;
            stan::math::assign(mean_lp_pfs, get_base1(beta_pfs, 1, "beta_pfs", 1));
            current_statement_begin__ = 705;
            if (as_bool(logical_eq(bg_model, 1))) {
                current_statement_begin__ = 706;
                stan::math::assign(mean_lp_bg, stan::math::exp(get_base1(beta_bg, 1, "beta_bg", 1)));
            } else {
                current_statement_begin__ = 708;
                stan::math::assign(mean_lp_bg, 0.001);
            }
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(S_bg, 
                            ...
                            exp_Surv(i, mean_lp_bg, pstream__), 
                            "assigning variable S_bg");
                current_statement_begin__ = 714;
                stan::model::assign(S_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_lognormal_Surv(i, mean_lp_os, sd_os, mean_lp_bg, pstream__), 
                            "assigning variable S_os");
                current_statement_begin__ = 715;
                stan::model::assign(S_pfs, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_lognormal_Surv(i, mean_lp_pfs, sd_pfs, mean_lp_bg, pstream__), 
            ...
            stan::math::assign(pmean_os, pbeta_os);
            current_statement_begin__ = 723;
            stan::math::assign(pmean_pfs, pbeta_pfs);
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(pS_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_lognormal_Surv(i, pmean_os, psd_os, pmean_bg, pstream__), 
                            "assigning variable pS_os");
                current_statement_begin__ = 729;
                stan::model::assign(pS_pfs, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            exp_lognormal_Surv(i, pmean_pfs, psd_pfs, pmean_bg, pstream__), 
            ...
            for (int n = 1; n <= n_os; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            (log_sum_exp((stan::math::log(cf_os) + surv_exp_lpdf(get_base1(t_os, n, "t_os", 1), get_base1(d_os, n, "d_os", 1), get_base1(lambda_os_bg, n, "lambda_os_bg", 1), pstream__)), (log1m(cf_os) + joint_exp_lognormal_lpdf(get_base1(t_os, n, "t_os", 1), get_base1(d_os, n, "d_os", 1), get_base1(mean_os, n, "mean_os", 1), sd_os, get_base1(lambda_os_bg, n, "lambda_os_bg", 1), pstream__))) + log_sum_exp((stan::math::log(cf_pfs) + surv_exp_lpdf(get_base1(t_pfs, n, "t_pfs", 1), get_base1(d_pfs, n, "d_pfs", 1), get_base1(lambda_pfs_bg, n, "lambda_pfs_bg", 1), pstream__)), (log1m(cf_pfs) + joint_exp_lognormal_lpdf(get_base1(t_pfs, n, "t_pfs", 1), get_base1(d_pfs, n, "d_pfs", 1), get_base1(mean_pfs, n, "mean_pfs", 1), sd_pfs, get_base1(lambda_pfs_bg, n, "lambda_pfs_bg", 1), pstream__)))), 
                            "assigning variable log_lik");
            }
            current_statement_begin__ = 753;
            for (int i = 1; i <= n_os; ++i) {
                current_statement_begin__ = 755;
                stan::model::assign(cf_tilde, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            uniform_rng(0, 1, base_rng__), 
                            "assigning variable cf_tilde");
                current_statement_begin__ = 757;
                if (as_bool(logical_lt(get_base1(cf_tilde, i, "cf_tilde", 1), cf_os))) {
                    current_statement_begin__ = 758;
                    stan::model::assign(t_os_tilde, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                exponential_rng(get_base1(lambda_os_bg, i, "lambda_os_bg", 1), base_rng__), 
                                "assigning variable t_os_tilde");
                } else {
                    current_statement_begin__ = 760;
                    stan::model::assign(t_os_tilde, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                exp_lognormal_rng(get_base1(mean_os, i, "mean_os", 1), sd_os, get_base1(lambda_os_bg, i, "lambda_os_bg", 1), base_rng__, pstream__), 
                                "assigning variable t_os_tilde");
                }
                current_statement_begin__ = 763;
                if (as_bool(logical_lt(get_base1(cf_tilde, i, "cf_tilde", 1), cf_pfs))) {
                    current_statement_begin__ = 764;
                    stan::model::assign(t_pfs_tilde, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                exponential_rng(get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), base_rng__), 
                                "assigning variable t_pfs_tilde");
                } else {
                    current_statement_begin__ = 766;
                    stan::model::assign(t_pfs_tilde, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                exp_lognormal_rng(get_base1(mean_pfs, i, "mean_pfs", 1), sd_pfs, get_base1(lambda_pfs_bg, i, "lambda_pfs_bg", 1), base_rng__, pstream__), 
                                "assigning variable t_pfs_tilde");
                }
            }
            // validate, write generated quantities
            current_statement_begin__ = 631;
            vars__.push_back(mean_lp_os);
            current_statement_begin__ = 632;
            vars__.push_back(mean_lp_pfs);
            current_statement_begin__ = 633;
            vars__.push_back(mean_lp_bg);
            current_statement_begin__ = 635;
            ...
            current_statement_begin__ = 660;
            vars__.push_back(psd_os);
            current_statement_begin__ = 662;
            vars__.push_back(pbeta_bg);
            current_statement_begin__ = 664;
            size_t cf_tilde_i_0_max__ = n_os;
            for (size_t i_0__ = 0; i_0__ < cf_tilde_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "cf_tilde[i_0__]", cf_tilde[i_0__], 0);
                check_less_or_equal(function__, "cf_tilde[i_0__]", cf_tilde[i_0__], 1);
            }
            size_t cf_tilde_k_0_max__ = n_os;
            for (size_t k_0__ = 0; k_0__ < cf_tilde_k_0_max__; ++k_0__) {
                vars__.push_back(cf_tilde[k_0__]);
            }
            current_statement_begin__ = 665;
            size_t t_os_tilde_i_0_max__ = n_os;
            for (size_t i_0__ = 0; i_0__ < t_os_tilde_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "t_os_tilde[i_0__]", t_os_tilde[i_0__], 0);
            }
            size_t t_os_tilde_k_0_max__ = n_os;
            for (size_t k_0__ = 0; k_0__ < t_os_tilde_k_0_max__; ++k_0__) {
                vars__.push_back(t_os_tilde[k_0__]);
            }
            current_statement_begin__ = 666;
            size_t t_pfs_tilde_i_0_max__ = n_os;
            ...
            size_t t_pfs_tilde_k_0_max__ = n_os;
    ...
    std::string model_name() const {
        return "model_lognormal_lognormal";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < mean_os_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "mean_os" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t mean_pfs_j_1_max__ = n_pfs;
            for (size_t j_1__ = 0; j_1__ < mean_pfs_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "mean_pfs" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t lambda_os_bg_j_1_max__ = n_os;
            for (size_t j_1__ = 0; j_1__ < lambda_os_bg_j_1_max__; ++j_1__) {
        ...
        if (!include_gqs__) return;
        param_name_stream__.str(std::string());
        param_name_stream__ << "mean_lp_os";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mean_lp_pfs";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mean_lp_bg";
        param_names__.push_back(param_name_stream__.str());
        size_t S_bg_j_1_max__ = t_max;
        for (size_t j_1__ = 0; j_1__ < S_bg_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
        ...
        for (size_t k_0__ = 0; k_0__ < cf_tilde_k_0_max__; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cf_tilde" << '.' << k_0__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t t_os_tilde_k_0_max__ = n_os;
        for (size_t k_0__ = 0; k_0__ < t_os_tilde_k_0_max__; ++k_0__) {
...
typedef model_lognormal_lognormal_namespace::model_lognormal_lognormal stan_model;
#ifndef USING_R
