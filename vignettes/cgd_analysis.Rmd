...
In @Lai hospital-level random effects are assigned to the cured probability part, and both patient- and hospital-level random effects are assigned to hazard function part. `{multimcm}` currently only applies hierarchical structure to the cure fraction and not to the separate hazards.
