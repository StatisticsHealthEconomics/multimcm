...
knitr::include_graphics("../plots/plot_S_samepair_grid_cf_separate_diffuncured.png")
```
...
knitr::include_graphics("../plots/plot_S_samepair_grid_cf_hier_diffuncured.png")
```
