...
#include "stanExports_postpred_weibull_weibullTx.h"

RCPP_MODULE(stan_fit4postpred_weibull_weibullTx_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_postpred_weibull_weibullTx")
