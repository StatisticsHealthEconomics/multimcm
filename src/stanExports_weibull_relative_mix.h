...
namespace model_weibull_relative_mix_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_weibull_relative_mix");
    ...
    reader.add_event(176, 5, "restart", "model_weibull_relative_mix");
    reader.add_event(262, 89, "end", "model_weibull_relative_mix");
    return reader;
}
...
class model_weibull_relative_mix
  : public stan::model::model_base_crtp<model_weibull_relative_mix> {
private:
        int n;
        vector_d t;
        vector_d d;
        ...
        int t_max;
public:
    model_weibull_relative_mix(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_weibull_relative_mix_namespace::model_weibull_relative_mix";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_weibull_relative_mix_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_weibull_relative_mix";
    }
...
typedef model_weibull_relative_mix_namespace::model_weibull_relative_mix stan_model;
#ifndef USING_R
