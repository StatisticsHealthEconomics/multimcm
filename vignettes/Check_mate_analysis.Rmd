...
complicated for other survival distributions.
The parameters $\phi_{iOS}$ and $\phi_{iPFS}$ are the uncured hazard rates for
...
$$
Notice that the coefficients $\beta_0^*$ and $\beta^*_1$ are the same in both equations .
