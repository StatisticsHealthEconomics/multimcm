...
namespace model_weibull_weibull_joint_mix_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_weibull_weibull_joint_mix");
    reader.add_event(4, 4, "include", "/include/distributions.stan");
    reader.add_event(4, 0, "start", "/include/distributions.stan");
    reader.add_event(176, 172, "end", "/include/distributions.stan");
    reader.add_event(176, 5, "restart", "model_weibull_weibull_joint_mix");
    reader.add_event(341, 168, "end", "model_weibull_weibull_joint_mix");
    return reader;
}
...
class model_weibull_weibull_joint_mix
  : public stan::model::model_base_crtp<model_weibull_weibull_joint_mix> {
private:
        int n_os;
        int n_pfs;
        int H_os;
        ...
        int t_max;
public:
    model_weibull_weibull_joint_mix(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_weibull_weibull_joint_mix_namespace::model_weibull_weibull_joint_mix";
    ...
    ~model_weibull_weibull_joint_mix() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(mean_t_pfs, multiply(lambda_pfs, stan::math::tgamma((1 + (1 / alpha_os)))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_weibull_weibull_joint_mix_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(S_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            weibull_Surv(i, alpha_os, mean_os, pstream__), 
            ...
            for (int i = 1; i <= t_max; ++i) {
                ...
                stan::model::assign(pS_os, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            weibull_Surv(i, palpha_os, pmean_os, pstream__), 
    ...
    std::string model_name() const {
        return "model_weibull_weibull_joint_mix";
    }
...
typedef model_weibull_weibull_joint_mix_namespace::model_weibull_weibull_joint_mix stan_model;
#ifndef USING_R
