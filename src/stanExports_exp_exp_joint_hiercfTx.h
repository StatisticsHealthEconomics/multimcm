...
namespace model_exp_exp_joint_hiercfTx_namespace {
using std::istream;
using std::string;
...
class model_exp_exp_joint_hiercfTx
  : public stan::model::model_base_crtp<model_exp_exp_joint_hiercfTx> {
private:
        int nTx;
        int N_os;
        int N_pfs;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exp_exp_joint_hiercfTx_namespace::model_exp_exp_joint_hiercfTx";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exp_exp_joint_hiercfTx_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_exp_exp_joint_hiercfTx";
    }
...
typedef model_exp_exp_joint_hiercfTx_namespace::model_exp_exp_joint_hiercfTx stan_model;
#ifndef USING_R
