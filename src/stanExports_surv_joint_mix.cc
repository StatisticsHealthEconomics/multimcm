...
#include "stanExports_surv_joint_mix.h"

RCPP_MODULE(stan_fit4surv_joint_mix_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_surv_joint_mix")
