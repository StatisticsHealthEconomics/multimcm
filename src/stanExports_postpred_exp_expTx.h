...
namespace model_postpred_exp_expTx_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_postpred_exp_expTx");
    reader.add_event(80, 78, "end", "model_postpred_exp_expTx");
    return reader;
}
...
rate_mean_rng(const Eigen::Matrix<T0__, 1, Eigen::Dynamic>& curefrac,
                  const T1__& lambda0,
...
template <typename T0__, typename T1__, typename T2__, class RNG>
Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T2__>::type, 1, Eigen::Dynamic>
rate_casemix_rng(const Eigen::Matrix<T0__, 1, Eigen::Dynamic>& curefrac,
...
class model_postpred_exp_expTx
  : public stan::model::model_base_crtp<model_postpred_exp_expTx> {
private:
        int N_os;
        int N_pfs;
        double os_model;
...
public:
    model_postpred_exp_expTx(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_postpred_exp_expTx_namespace::model_postpred_exp_expTx";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_postpred_exp_expTx_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("lambda_os_tilde", "N_os", N_os);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> lambda_os_tilde(n_samples, N_os);
            ...
            validate_non_negative_index("lambda_pfs_tilde", "N_pfs", N_pfs);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> lambda_pfs_tilde(n_samples, N_pfs);
            ...
            std::vector<std::vector<double> > t_os_tilde(n_samples, std::vector<double>(N_os, double(0)));
            ...
            std::vector<std::vector<double> > t_pfs_tilde(n_samples, std::vector<double>(N_pfs, double(0)));
            ...
            for (int i = 1; i <= n_samples; ++i) {
                ...
                stan::model::assign(lambda_os_tilde, 
                            ...
                            rate_casemix_rng(stan::model::rvalue(cf_os, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "cf_os"), stan::model::rvalue(lambda_os, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "lambda_os"), stan::model::rvalue(lambda_os_bg, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "lambda_os_bg"), N_os, base_rng__, pstream__), 
            ...
            current_statement_begin__ = 63;
            size_t lambda_os_tilde_j_2_max__ = N_os;
            ...
            current_statement_begin__ = 64;
            size_t lambda_pfs_tilde_j_2_max__ = N_pfs;
            ...
            size_t t_os_tilde_i_1_max__ = N_os;
            ...
            size_t t_os_tilde_k_1_max__ = N_os;
            ...
            size_t t_pfs_tilde_i_1_max__ = N_pfs;
            ...
            size_t t_pfs_tilde_k_1_max__ = N_pfs;
    ...
    std::string model_name() const {
        return "model_postpred_exp_expTx";
    }
...
typedef model_postpred_exp_expTx_namespace::model_postpred_exp_expTx stan_model;
#ifndef USING_R
