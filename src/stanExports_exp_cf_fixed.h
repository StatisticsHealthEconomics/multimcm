...
namespace model_exp_cf_fixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_exp_cf_fixed");
    ...
    reader.add_event(418, 5, "restart", "model_exp_cf_fixed");
    reader.add_event(488, 73, "end", "model_exp_cf_fixed");
    return reader;
}
...
class model_exp_cf_fixed
  : public stan::model::model_base_crtp<model_exp_cf_fixed> {
private:
        int n;
        vector_d t;
        vector_d d;
        ...
        int t_max;
public:
    model_exp_cf_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exp_cf_fixed_namespace::model_exp_cf_fixed";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "curefrac", "double", context__.to_vec());
            curefrac = double(0);
            vals_r__ = context__.vals_r("curefrac");
            pos__ = 0;
            curefrac = vals_r__[pos__++];
            check_greater_or_equal(function__, "curefrac", curefrac, 0);
            check_less_or_equal(function__, "curefrac", curefrac, 1);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exp_cf_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_exp_cf_fixed_namespace::model_exp_cf_fixed stan_model;
#ifndef USING_R
