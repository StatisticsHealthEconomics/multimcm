...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(7, 7, "include", "/include/distributions.stan");
    reader.add_event(7, 0, "start", "/include/distributions.stan");
    reader.add_event(151, 144, "end", "/include/distributions.stan");
    reader.add_event(151, 8, "restart", "model_exp_exp_joint_mix");
