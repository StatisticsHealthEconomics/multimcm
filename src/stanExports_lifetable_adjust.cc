...
#include "stanExports_lifetable_adjust.h"

RCPP_MODULE(stan_fit4lifetable_adjust_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lifetable_adjust")
