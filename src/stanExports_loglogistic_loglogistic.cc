...
#include "stanExports_loglogistic_loglogistic.h"

RCPP_MODULE(stan_fit4loglogistic_loglogistic_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_loglogistic_loglogistic")
