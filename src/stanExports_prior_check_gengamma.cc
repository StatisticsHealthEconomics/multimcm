...
#include "stanExports_prior_check_gengamma.h"

RCPP_MODULE(stan_fit4prior_check_gengamma_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_prior_check_gengamma")
