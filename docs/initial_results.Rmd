...
or death i.e. $S_u = S_{prog} S^*_u$. We use World Health Organization
...
the event. The mortality data are age- and gender adjusted, thus
...
The Weibull is defined as follows
...
Substituting $S(t)$ and $h(t)$ into (\*\*) the combined pdf is
...
underlying bivariate distribution.
