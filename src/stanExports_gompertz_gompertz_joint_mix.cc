...
#include "stanExports_gompertz_gompertz_joint_mix.h"

RCPP_MODULE(stan_fit4gompertz_gompertz_joint_mix_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_gompertz_gompertz_joint_mix")
